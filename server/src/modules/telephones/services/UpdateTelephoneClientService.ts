...
@injectable()
class UpdateTelephoneClientService {
  constructor(
  ...
  public async execute({
    ...
    const telephoneUpdated = await this.telephonesRepository.updateClientTelephone(
      telephone_id,
      new_telephone,
    );
...
export default UpdateTelephoneClientService;
